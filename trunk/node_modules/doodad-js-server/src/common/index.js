...
// File: index.js - Server module startup file
...
(function() {
	...
	var MODULE_NAME = 'doodad-js-server';
	...
	exports.add = function add(DD_MODULES) {
		...
		DD_MODULES[MODULE_NAME] = {
			...
			create: function create(root, /*optional*/_options) {
				...
				return modules.load(MODULE_NAME, (fromSource ? 'src/server/Server.js' : 'Server.min.js'), _options)
					.then(function() {
						// Returns nothing
					});
			},
